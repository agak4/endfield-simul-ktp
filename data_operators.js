...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        talents: [
            [{ type: ['냉기 취약'], trigger: ['냉기 부착'], perStack: '4%', target: '적' }],
            [{ type: ['냉기 취약 증폭'], val: 0.5, target: '적', skillType: ['궁극기'], desc: '궁극기 피해를 줄 때, 적이 냉기 취약 상태일 경우, 해당 냉기 취약 효과를 기존의 1.5배로 간주합니다.' }]
        ],
        potential: [

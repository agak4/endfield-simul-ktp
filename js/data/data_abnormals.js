const DATA_ABNORMALS = {
    ...
    '아츠 폭발': {
        element: 'arts',
        base: '160%',
        desc: '부착 상태의 적에게 동일한 속성의 아츠를 추가로 부착시키면 아츠 폭발이 발생하여 해당 속성의 피해를 줍니다.'
    },
    ...
    '동결': {
        ...
        base: '130%',
        trigger: '아츠 부착',
        desc: '다른 아츠 부착 상태의 적에게 냉기 부착을 부여하면, 모든 아츠 부착을 소모하고, 한 차례의 냉기 피해를 주며, 적을 동결 상태로 만듭니다.<br> 동결 상태가 된 경우, 약한 적은 움직일 수 없게 됩니다.<br>동결 상태의 적에게 방어 불능 혹은 물리 이상 효과를 부여하면 쇄빙이 발동합니다.<br> 쇄빙은 적의 동결 상태를 소모하고, 대량의 물리 피해를 줍니다.<br>동결은 소모한 아츠 부착의 스택 수치가 많을수록 초기 피해가 증가하며, 동결의 지속 시간이 길어지고, 쇄빙 피해가 증가합니다.<br>강제로 부여된 동결은 초기 피해가 없습니다.'
    },
    '부식': {
        element: 'nature',
        base: '80%',
    ...
    '쇄빙': {
        ...
        perStack: '120%',
        trigger: '동결',
        desc: '동결 상태의 적에게 방어 불능 혹은 물리 이상을 부여하면 쇄빙이 발동합니다. 쇄빙은 적의 동결 상태를 소모하고, 대량의 물리 피해를 줍니다. 피해량은 소모한 동결 스택 수치에 따라 증가합니다.'
    }
};

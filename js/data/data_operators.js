...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        potential: [
            ...
            [{ desc: '배틀 스킬 세쉬카의 비전이 반환하는 스킬 게이지가 추가로 5포인트 증가하고, 생성한 환영 추격의 피해 배율이 기존의 1.2배로 증가합니다.' }]
        ]
    },
    {
        id: 'Yvonne',
    ...
    },
    {
        ...
        potential: [
            ...
            [{ type: ['스킬 배율 증가'], dmg: '15%', skillType: ['배틀 스킬'], trigger: ['전기 취약'], desc: '회수한 썬더랜스 및 강력한 썬더랜스가 전기 취약 상태의 적을 명중했을 때, 피해 배율이 기존의 1.15배로 증가합니다.' }]
        ]
    },
    {
        id: 'Da Pan',

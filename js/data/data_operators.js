...
const DATA_OPERATORS = [
    ...
    },
    {
        ...
        skill: [
            ...
            {
                skillType: ['궁극기'], element: '', cost: 0, desc: '탕탕이 안대를 벗어 던지고 눈 속에 깃든 고대의 진을 발동합니다. 범위 내의 적은 일정 시간 동안 움직일 수 없으며, 지속적으로 냉기 피해를 받습니다. 고대의 진은 나타난 직후부터 서서히 변화를 시작해 변화가 끝날 때 거대한 파도를 일으키고 범위 내의 적에게 대량의 냉기 피해를 줍니다. 메인 컨트롤 오퍼레이터가 고대의 진 내에서 낙하 공격을 사용하면, 변화하던 고대의 진이 그 변화를 중단합니다. 이어서 거대한 파도를 일으키고, 이때 파도가 주는 냉기 피해가 증가합니다.',
                levels: {
                    M0: { dmg: '0%', type: [''] },
                    M1: { dmg: '0%', type: [''] },
                    M2: { dmg: '0%', type: [''] },
        ...
        talents: [
            ...
            [{ type: [''], target: '', desc: '메인 컨트롤 오퍼레이터가 고대의 진 내에서 낙하 공격을 사용하면, 변화하던 고대의 진이 그 변화를 중단합니다. 이어서 용오름 1개를 생성하며, 주변에 와류가 존재할 경우 이를 소모하여 추가로 용오름을 생성합니다.<br>이때 생성한 용오름은 배틀 스킬 우당탕탕 파도!와 동일한 효과를 가지고 있으며, 주는 피해 +60%' }]
        ],
        potential: [
            [{ type: [''], val: '', stack: 0, desc: '연계 스킬 야, 강물! 도와줘!의 피해 배율이 기존의 1.2배로 증가하며, 쿨타임 -2초.<br>배틀 스킬 우당탕탕 파도!로 와류 한 곳을 소모하여 용오름이 생성될 때마다, 추가로 스킬 게이지 5포인트를 반환합니다.' }],
            [{ type: [''], stats: '', val: 0 }, { type: [''], stats: '', val: 0, desc: '민첩 +20, 냉기 피해 +10%' }],
            [{ type: [''], val: '', target: '', desc: '배틀 스킬 우당탕탕 파도!의 피해 배율이 기존의 1.1배로 증가하며, 동시에 여러 개의 용오름이 생성될 때 부여하는 아츠 취약 효과가 추가로 +5%' }],
            [{ type: [''], val: '', desc: '궁극기 대당가께서 지켜보고 계신다!의 사용에 필요한 궁극기 에너지 -15%' }],
            [{ desc: '궁극기 대당가께서 지켜보고 계신다!의 피해 배율이 기존의 1.15배로 증가합니다.<br>재능 풍랑의 주재자 효과 강화: 궁극기 대당가께서 지켜보고 계신다!로 생성된 용오름의 피해 증가 추가로 +80%' }]
        ]
    },
    {
        id: 'Rossi',

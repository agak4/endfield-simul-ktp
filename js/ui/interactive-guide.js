...
const interactiveGuideSteps = [
    ...
    },
    {
        ...
        text: '메인 오퍼레이터의 스킬 마스터리와 사이클을 설정하는 영역입니다. 스킬 버튼을 눌러 사이클에 추가할 수 있으며, 추가된 스킬은 꾹 눌러 순서를 변경하거나, 우클릭으로 사이클에서 제거할 수 있습니다.<br>사이클에 추가된 스킬을 클릭하면 스킬의 개별 설정을 할 수 있습니다.'
    },
    {
    ...
    },
    {
        ...
        text: '사이클에 추가된 스킬의 옵션 설정 영역입니다. 개별 항목을 클릭하여 비활성화 할 수 있으며, 중첩 옵션의 경우 클릭하여 중첩 단계를 설정할 수 있습니다.<br><br>각 타일 우상단의 핸들을 드래그하여 다른 옵션 타일과 위치를 변경할 수 있습니다.'
    },
    {

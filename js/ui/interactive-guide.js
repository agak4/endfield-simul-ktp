...
const interactiveGuideSteps = [
    ...
    },
    {
        ...
        text: '메인 오퍼레이터의 스킬 마스터리와 사이클을 설정하는 영역입니다. 스킬 버튼을 눌러 사이클에 추가할 수 있으며, 추가된 스킬은 꾹 눌러 순서를 변경하거나, 우클릭으로 사이클에서 제거할 수 있습니다.<br><br>사이클에 추가된 스킬을 클릭하거나 사이클 영역을 드래그하여 스킬의 개별 설정을 할 수 있습니다. 스킬을 클릭하지 않은 채로 버프 및 디버프, 옵션을 설정하면 모든 사이클에 동일하게 적용됩니다.'
    },
    {

...
const interactiveGuideSteps = [
    ...
    },
    {
        ...
        text: '메인 오퍼레이터의 스킬 마스터리와 사이클을 설정하는 영역입니다.<br>스킬 버튼을 눌러 사이클에 추가할 수 있으며, 추가된 스킬은 꾹 눌러 순서를 변경하거나, 우클릭으로 사이클에서 제거할 수 있습니다.<br><br>사이클에 추가된 스킬을 클릭하여 스킬의 개별 설정을 할 수 있습니다.<br>사이클 영역을 드래그하거나 Ctrl, Shift를 누른 채 스킬을 클릭하면 여러 스킬을 동시에 선택하여 개별 설정을 할 수 있습니다.<br>스킬을 클릭하지 않은 채로 버프 및 디버프, 옵션을 설정하면 모든 사이클에 동일하게 적용됩니다.'
    },
    {
        target: '.debuff-icon-section',
        text: '사이클에 추가된 스킬들에 대해 버프 및 디버프를 설정하는 영역입니다.<br>조건이 필요한 스킬의 경우 해당 버프 및 디버프를 활성화해야 적용됩니다.(ex 관리자의 오리지늄 결정)<br><br>띄우기 등 물리이상을 가진 스킬은 방어불능을 활성화해야 적용됩니다.<br>아츠부착을 가진 스킬은 다른 아츠부착을 활성화하면 아츠이상이 적용되며, 같은 아츠부착을 활성화하면 아츠폭발이 적용됩니다.<br><br>스킬을 추가해도 자동으로 스킬의 디버프가 발동하지 않습니다. 예를 들어 아츠부착 스킬을 추가해도 자동으로 아츠부착이 활성화되지 않습니다.'
    },
    {
        target: '.tile[data-tile-id="atk"]',
        text: '사이클에 추가된 스킬의 스탯 옵션 설정 영역입니다.<br>개별 항목을 클릭하여 비활성화 할 수 있으며, 중첩 옵션의 경우 클릭하여 중첩 단계를 설정할 수 있습니다.<br><br>각 타일 우상단의 핸들을 드래그하여 다른 옵션 타일과 위치를 변경할 수 있습니다.'
    },
    {
    ...
    },
    {
        ...
        text: '메인 오퍼레이터의 무기를 비교하는 영역입니다.<br>잠재 단계와 기질 여부를 설정할 수 있습니다.<br>해당 무기를 착용했을 때의 예상 데미지를 표시하며, 중첩 옵션을 가진 무기의 경우 최대 중첩을 가정하여 적용됩니다.'
    }
];
